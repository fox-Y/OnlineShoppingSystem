...
✔ Transactional inventory deduction & rollback on order placement/cancellation
✔ Order status workflow: PROCESSING → COMPLETED or CANCELED
✔ Historical prices stored in order_item (not affected by later price changes)
✔ Wishlist, frequent purchases, popular products, and profit dashboards
